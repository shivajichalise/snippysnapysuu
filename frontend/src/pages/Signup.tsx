...
const Signup = () => {
    ...
    useEffect(() => {
        ...
        setConfirmPasswordError(
            errors.find((e) => e.path === "password_confirmation")
        )
    }, [errors])
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <div className="flex flex-col items-center justify-center p-4">
                            ...
                            <h1 className="my-2 text-lg">
                                Signup to SnipySnapySuu
                            </h1>
                            <div className="bg-200 w-full rounded-md p-6 text-white">
                                <form onSubmit={submitForm}>
                                    <InputText
                                        ref={nameRef}
                                        name="name"
                                        id="name"
                                        placeholder="User Jr White"
                                        hasLabel={true}
                                        inputLabel="Name"
                                        required={true}
                                    />
                                    ...
                                    {confirmPasswordError && (
                                        <SpanAlert
                                            type="error"
                                            message={confirmPasswordError.msg}
                                        />
                                    )}
                        ...
                        <div className="bg-300 border-100 w-max rounded-md border p-3 text-white">
                            <p className="text-sm">
                                Already an account?{" "}
                                <Link
                                    className="hover:text-primary-300 text-primary-200 cursor-pointer text-sm hover:underline"
                                    to="/login"
                                >
                                    Login
                                </Link>
